...
static_assert(sizeof(bmpBITMAPFILEHEADER) == 14, "BMP file header must be 14 bytes");
static_assert(sizeof(bmpBITMAPINFOHEADER) == 40, "BITMAPINFOHEADER must be 40 bytes");
